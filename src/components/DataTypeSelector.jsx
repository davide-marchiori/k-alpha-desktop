...
export function DataTypeSelector() {
  ...
  return (
    <fieldset className="border border-solid border-gray-300 rounded-md p-3 m-3">
      <legend className="text-base">
        <b>Type of Data</b>
      </legend>
      <div className="m-3 grid grid-cols-1 gap-5 sm:grid-cols-4 sm:gap-5 lg:grid-cols-6">
